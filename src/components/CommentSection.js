  ...
  return (
    <div className={styles.wrapper}>
      ...
      {user ? (
        ...
        <div className={styles.loginHint}>로그인 후 댓글을 작성할 수 있어요.</div>
      )}
    </div>
  );
}
    ...
    <div className="comment-item">
      <div className={styles.itemHeader}>
        <div className={styles.itemBody}>
          <div className={styles.itemNickname}>{comment.nickname}</div>
          {editing ? (
            <div className={styles.editRow}>
              <textarea rows={2} value={editText} onChange={e => setEditText(e.target.value)} className={styles.textarea} />
      ...
      {replies.map(r => {
        ...
        return (
          <div key={r.id} className="reply-item">
            <div className={styles.itemHeader}>
              <div className={styles.itemBody}>
                <div className={styles.itemNickname}>{r.nickname}</div>
                {rEditing ? (
                  <div className={styles.editRow}>
                    <textarea rows={2} value={editText} onChange={e => setEditText(e.target.value)} className={styles.textarea} />
